...
export default function HomeScreen({ navigation }: RootTabScreenProps<'Home'>){
    ...
    const renderCard = (item:number) => {
        return <CardInfo info={'WoW Classic'} Rating={item}/>
    }
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.scrollWrapper}>
                <FlatList style={styles.list} data={RIS} renderItem={({item}) => <CardInfo info={'WoWClassic'} Rating={item}/> } keyExtractor={(item:number, index) => index.toString()}/>
            </View>
        </View>
    );
}
